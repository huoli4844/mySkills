...
**概念建构四步法**（详见教授级教学法目录 §二）：
- Step 1 现象：[用什么具体场景引入]
- Step 2 定义：[核心术语的定义，引用哪个标准]
- Step 3 辨析：[与哪个易混概念做 ≥8维对比表]
- Step 4 深化：[在什么层面深化理解]
...
| # | 要素 | 具体要求 | 本节落实 |
|:-:|:-----|:---------|:--------:|
| 1 | **概念辨析对比表** | ≥8维度，如 §二 模板 | 对比什么 vs 什么？ |
| 2 | **编号公式 + 推导** | `\tag{{章-序号}}` + 5步推导法（§四） | 写出公式名 |
| 3 | **Mermaid 图** | `graph LR` + 图注 + 3~8句解释（§五） | 展示什么关系？ |
| 4 | **真实案例 ×2** | 1生活化+1工程，三段式结构（§三） | 案例名列表 |
| 5 | **脚手架四要素** | 设问/直觉/教学/呼应 各≥1处（§六） | 具体位置？ |
| 6 | **教材交叉引用** | 每要素标注来源：路宏敏§X / 张亮§X / 柯金良§X / 梁振光§X | 对应关系？ |
